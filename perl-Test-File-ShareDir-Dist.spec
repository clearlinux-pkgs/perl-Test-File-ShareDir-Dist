...
cp %{_builddir}/Test-File-ShareDir-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/perl-Test-File-ShareDir-Dist/e7f3f3f70b446efad21498b493e4a3e3625e2df5 || :
if test -f Makefile.PL; then
